                ...
                <li class="nav-main-item open">
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item open">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link active" href="be_pages_ecom_store_home.html">
        ...
        <div class="content">
            ...
            <div class="row push">
                <div class="col-xl-4 order-xl-1">
                    ...
                    <div class="block js-ecom-div-cart d-none d-xl-block">
                        ...
                        <div class="block-content">
                            <table class="table table-borderless table-hover table-vcenter">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="h5" href="be_pages_ecom_store_product.html">Iconic</a>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 60px;">
                                        <img class="img-fluid" src="assets/media/various/ecom_product2.png" alt="">
                                    </td>
                                    <td>
                                        <a class="h5" href="be_pages_ecom_store_product.html">Mailday</a>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 60px;">
                                        <img class="img-fluid" src="assets/media/various/ecom_product3.png" alt="">
                                    </td>
                                    <td>
                                        <a class="h5" href="be_pages_ecom_store_product.html">Office Suite</a>
                        ...
                        <div class="block-content block-content-full bg-body-light text-right">
                            <a class="btn btn-sm btn-primary" href="be_pages_ecom_store_checkout.html">
                ...
                <div class="col-xl-8 order-xl-0">
                    ...
                    <div class="text-right">
                        <a class="font-size-sm font-w600 link-fx" href="be_pages_ecom_store_products.html">View More Best Sellers..</a>
                    </div>
                    <!-- END Best Sellers -->
                    ...
                    <div class="row row-deck">
                        <div class="col-md-6 col-xl-4">
                            <div class="block">
                                <div class="options-container">
                                    <img class="img-fluid options-item" src="assets/media/various/ecom_product9.png" alt="">
                                    <div class="options-overlay bg-black-75">
                                        <div class="options-overlay-content">
                                            <a class="btn btn-sm btn-light" href="be_pages_ecom_store_product.html">
                                                View
                                ...
                                <div class="block-content">
                                    <div class="mb-2">
                                        ...
                                        <a class="h4" href="be_pages_ecom_store_product.html">MapNow</a>
                                    </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="block">
                                <div class="options-container">
                                    <img class="img-fluid options-item" src="assets/media/various/ecom_product10.png" alt="">
                                    <div class="options-overlay bg-black-75">
                                        <div class="options-overlay-content">
                                            <a class="btn btn-sm btn-light" href="be_pages_ecom_store_product.html">
                                                View
                                ...
                                <div class="block-content">
                                    <div class="mb-2">
                                        <div class="h4 font-w600 text-success float-right ml-1">$44</div>
                                        <a class="h4" href="be_pages_ecom_store_product.html">Calendious</a>
                                    </div>
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="mb-2">
                                        ...
                                        <a class="h4" href="be_pages_ecom_store_product.html">Todo App</a>
                                    </div>
                    ...
                    <div class="text-right">
                        <a class="font-size-sm font-w600 link-fx" href="be_pages_ecom_store_products.html">View More Best Rated..</a>
                    </div>
                    <!-- END Best Rated -->
                </div>
            </div>
        ...
        <div class="bg-body-dark">
            <div class="content content-full">
                <div class="my-5 text-center">
                    ...
                    <a class="btn btn-rounded btn-success px-4 py-2 invisible" data-toggle="appear" data-class="animated bounceIn" href="be_pages_ecom_store_products.html">
